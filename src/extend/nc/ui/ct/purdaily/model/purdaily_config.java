...
public nc.ui.ct.purdaily.action.PuAddAction getAddAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuAddAction)context.get("addAction");
  ...
  bean.setModel(getManageAppModel());
  bean.setInterceptor(getCompositeActionInterceptor_1170f72());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor getCompositeActionInterceptor_1170f72(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#1170f72")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#1170f72");
  ...
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.CompositeActionInterceptor#1170f72",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getShowUpComponentInterceptor_141a674());  return list;}

private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_141a674(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#141a674")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#141a674");
  nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#141a674",bean);
  bean.setShowUpComponent(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ct.purdaily.action.PuEditAction getEditAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuEditAction)context.get("editAction");
  ...
  bean.setCardForm(getBillFormEditor());
  bean.setModel(getManageAppModel());
  bean.setInterceptor(getShowUpComponentInterceptor_f706f3());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_f706f3(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#f706f3")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#f706f3");
  nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#f706f3",bean);
  bean.setShowUpComponent(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.ct.purdaily.action.PuModiDeleteAction getModiDeleteAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuModiDeleteAction)context.get("modiDeleteAction");
  ...
  bean.setSingleBillService(getPuModiDeleteService_e5b0ac());
  bean.setModel(getManageAppModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.ct.purdaily.service.PuModiDeleteService getPuModiDeleteService_e5b0ac(){
 if(context.get("nc.ui.ct.purdaily.service.PuModiDeleteService#e5b0ac")!=null)
 return (nc.ui.ct.purdaily.service.PuModiDeleteService)context.get("nc.ui.ct.purdaily.service.PuModiDeleteService#e5b0ac");
  nc.ui.ct.purdaily.service.PuModiDeleteService bean = new nc.ui.ct.purdaily.service.PuModiDeleteService();
  context.put("nc.ui.ct.purdaily.service.PuModiDeleteService#e5b0ac",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.ct.purdaily.action.PuAddFromM28Action getPriceDeterAction(){
 ...
 return (nc.ui.ct.purdaily.action.PuAddFromM28Action)context.get("priceDeterAction");
  ...
  bean.setSourceBillName(getI18nFB_1b20f8a());
...
private java.lang.String getI18nFB_1b20f8a(){
 if(context.get("nc.ui.uif2.I18nFB#1b20f8a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b20f8a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b20f8a",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#1b20f8a",product);
...
public nc.ui.ct.purdaily.action.PuAddFromSourceAction getAddFrom20Action(){
 ...
 return (nc.ui.ct.purdaily.action.PuAddFromSourceAction)context.get("addFrom20Action");
  ...
  bean.setSourceBillName(getI18nFB_11a4fbe());
  bean.setFlowBillType(false);
  bean.setModel(getManageAppModel());
  bean.setEditor(getBillFormEditor());
  bean.setTransferViewProcessor(getTransferViewProcessor1());
...
private java.lang.String getI18nFB_11a4fbe(){
 if(context.get("nc.ui.uif2.I18nFB#11a4fbe")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#11a4fbe");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#11a4fbe",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#11a4fbe",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.ct.purdaily.handler.CTMaterialValidateService getUnfrozenpowervalidservice(){
 if(context.get("unfrozenpowervalidservice")!=null)
 return (nc.ui.ct.purdaily.handler.CTMaterialValidateService)context.get("unfrozenpowervalidservice");
  nc.ui.ct.purdaily.handler.CTMaterialValidateService bean = new nc.ui.ct.purdaily.handler.CTMaterialValidateService();
...
public nc.ui.ct.purdaily.handler.CTMaterialValidateService getUnterminatepowervalidservice(){
 if(context.get("unterminatepowervalidservice")!=null)
 return (nc.ui.ct.purdaily.handler.CTMaterialValidateService)context.get("unterminatepowervalidservice");
  nc.ui.ct.purdaily.handler.CTMaterialValidateService bean = new nc.ui.ct.purdaily.handler.CTMaterialValidateService();
...
public nc.ui.ct.purdaily.handler.CTMaterialValidateService getValidatepowervalidservice(){
 if(context.get("validatepowervalidservice")!=null)
 return (nc.ui.ct.purdaily.handler.CTMaterialValidateService)context.get("validatepowervalidservice");
  nc.ui.ct.purdaily.handler.CTMaterialValidateService bean = new nc.ui.ct.purdaily.handler.CTMaterialValidateService();
...
private Map getManagedMap1(){  Map map = new HashMap();  map.put("28",getCtPuInitDataProcessor_1799971());  map.put("3",getCTLinkQueryInitDataProcessor_48d7ce());  map.put("47",getCtPuInitDataProcessorForEC_503c82());  map.put("8",getCtPuOpenNodeInitDataProcessor_1b49cd1());  return map;}

private nc.ui.ct.purdaily.billref.CtPuInitDataProcessor getCtPuInitDataProcessor_1799971(){
 if(context.get("nc.ui.ct.purdaily.billref.CtPuInitDataProcessor#1799971")!=null)
 return (nc.ui.ct.purdaily.billref.CtPuInitDataProcessor)context.get("nc.ui.ct.purdaily.billref.CtPuInitDataProcessor#1799971");
  nc.ui.ct.purdaily.billref.CtPuInitDataProcessor bean = new nc.ui.ct.purdaily.billref.CtPuInitDataProcessor();
  context.put("nc.ui.ct.purdaily.billref.CtPuInitDataProcessor#1799971",bean);
...
private nc.ui.ct.view.CTLinkQueryInitDataProcessor getCTLinkQueryInitDataProcessor_48d7ce(){
 if(context.get("nc.ui.ct.view.CTLinkQueryInitDataProcessor#48d7ce")!=null)
 return (nc.ui.ct.view.CTLinkQueryInitDataProcessor)context.get("nc.ui.ct.view.CTLinkQueryInitDataProcessor#48d7ce");
  nc.ui.ct.view.CTLinkQueryInitDataProcessor bean = new nc.ui.ct.view.CTLinkQueryInitDataProcessor();
  context.put("nc.ui.ct.view.CTLinkQueryInitDataProcessor#48d7ce",bean);
...
private nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC getCtPuInitDataProcessorForEC_503c82(){
 if(context.get("nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC#503c82")!=null)
 return (nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC)context.get("nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC#503c82");
  nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC bean = new nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC();
  context.put("nc.ui.ct.purdaily.billref.CtPuInitDataProcessorForEC#503c82",bean);
  bean.setTransferProcessor(getTransferViewProcessor1());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor getCtPuOpenNodeInitDataProcessor_1b49cd1(){
 if(context.get("nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor#1b49cd1")!=null)
 return (nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor)context.get("nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor#1b49cd1");
  nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor bean = new nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor();
  context.put("nc.ui.ct.purdaily.view.CtPuOpenNodeInitDataProcessor#1b49cd1",bean);
  bean.setFunNodeInitDataListener(getInitDataListener());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pubapp.uif2app.view.BillOrgPanel getOrgPanel(){
 ...
 return (nc.ui.pubapp.uif2app.view.BillOrgPanel)context.get("orgPanel");
  ...
  bean.setModel(getManageAppModel());
  bean.setType(getI18nFB_10b2c5d());
...
private java.lang.String getI18nFB_10b2c5d(){
 if(context.get("nc.ui.uif2.I18nFB#10b2c5d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#10b2c5d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#10b2c5d",bean);  bean.setResDir("4020003_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#10b2c5d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList28(){  List list = new ArrayList();  list.add(getCtPuAddLineAction_8d997c());  list.add(getCtPuInsertLineAction_57cc63());  list.add(getPuDeletRowAction_2b8932());  list.add(getManageBCopyLineAction_3c4b59());  list.add(getManageBPasteLineAction_76e51b());  list.add(getManageBPasteToTailLineAction_1bb8845());  list.add(getActionsBar_ActionsBarSeparator_ef8ab3());  list.add(getManageRearrangeRowLineAction_7b06de());  list.add(getBodyLineEditAction_fff8dd());  list.add(getActionsBar_ActionsBarSeparator_12bb64e());  list.add(getDefaultBodyZoomAction_cde797());  return list;}

private nc.ui.ct.purdaily.action.CtPuAddLineAction getCtPuAddLineAction_8d997c(){
 if(context.get("nc.ui.ct.purdaily.action.CtPuAddLineAction#8d997c")!=null)
 return (nc.ui.ct.purdaily.action.CtPuAddLineAction)context.get("nc.ui.ct.purdaily.action.CtPuAddLineAction#8d997c");
  nc.ui.ct.purdaily.action.CtPuAddLineAction bean = new nc.ui.ct.purdaily.action.CtPuAddLineAction();
  context.put("nc.ui.ct.purdaily.action.CtPuAddLineAction#8d997c",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.purdaily.action.CtPuInsertLineAction getCtPuInsertLineAction_57cc63(){
 if(context.get("nc.ui.ct.purdaily.action.CtPuInsertLineAction#57cc63")!=null)
 return (nc.ui.ct.purdaily.action.CtPuInsertLineAction)context.get("nc.ui.ct.purdaily.action.CtPuInsertLineAction#57cc63");
  nc.ui.ct.purdaily.action.CtPuInsertLineAction bean = new nc.ui.ct.purdaily.action.CtPuInsertLineAction();
  context.put("nc.ui.ct.purdaily.action.CtPuInsertLineAction#57cc63",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.purdaily.action.PuDeletRowAction getPuDeletRowAction_2b8932(){
 if(context.get("nc.ui.ct.purdaily.action.PuDeletRowAction#2b8932")!=null)
 return (nc.ui.ct.purdaily.action.PuDeletRowAction)context.get("nc.ui.ct.purdaily.action.PuDeletRowAction#2b8932");
  nc.ui.ct.purdaily.action.PuDeletRowAction bean = new nc.ui.ct.purdaily.action.PuDeletRowAction();
  context.put("nc.ui.ct.purdaily.action.PuDeletRowAction#2b8932",bean);
  bean.setTableCode("pk_ct_pu_b");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.ct.bodyaction.manage.ManageBCopyLineAction getManageBCopyLineAction_3c4b59(){
 if(context.get("nc.ui.ct.bodyaction.manage.ManageBCopyLineAction#3c4b59")!=null)
 return (nc.ui.ct.bodyaction.manage.ManageBCopyLineAction)context.get("nc.ui.ct.bodyaction.manage.ManageBCopyLineAction#3c4b59");
  nc.ui.ct.bodyaction.manage.ManageBCopyLineAction bean = new nc.ui.ct.bodyaction.manage.ManageBCopyLineAction();
  context.put("nc.ui.ct.bodyaction.manage.ManageBCopyLineAction#3c4b59",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.manage.ManageBPasteLineAction getManageBPasteLineAction_76e51b(){
 if(context.get("nc.ui.ct.bodyaction.manage.ManageBPasteLineAction#76e51b")!=null)
 return (nc.ui.ct.bodyaction.manage.ManageBPasteLineAction)context.get("nc.ui.ct.bodyaction.manage.ManageBPasteLineAction#76e51b");
  nc.ui.ct.bodyaction.manage.ManageBPasteLineAction bean = new nc.ui.ct.bodyaction.manage.ManageBPasteLineAction();
  context.put("nc.ui.ct.bodyaction.manage.ManageBPasteLineAction#76e51b",bean);
...
private nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction getManageBPasteToTailLineAction_1bb8845(){
 if(context.get("nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction#1bb8845")!=null)
 return (nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction)context.get("nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction#1bb8845");
  nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction bean = new nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction();
  context.put("nc.ui.ct.bodyaction.manage.ManageBPasteToTailLineAction#1bb8845",bean);
  bean.setClearItems(getPasteClearItem_ct_pu_b());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_ef8ab3(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#ef8ab3")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#ef8ab3");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#ef8ab3",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction getManageRearrangeRowLineAction_7b06de(){
 if(context.get("nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction#7b06de")!=null)
 return (nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction)context.get("nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction#7b06de");
  nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction bean = new nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction();
  context.put("nc.ui.ct.bodyaction.manage.ManageRearrangeRowLineAction#7b06de",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.BodyLineEditAction getBodyLineEditAction_fff8dd(){
 if(context.get("nc.ui.pubapp.uif2app.actions.BodyLineEditAction#fff8dd")!=null)
 return (nc.ui.pubapp.uif2app.actions.BodyLineEditAction)context.get("nc.ui.pubapp.uif2app.actions.BodyLineEditAction#fff8dd");
  nc.ui.pubapp.uif2app.actions.BodyLineEditAction bean = new nc.ui.pubapp.uif2app.actions.BodyLineEditAction();
  context.put("nc.ui.pubapp.uif2app.actions.BodyLineEditAction#fff8dd",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_12bb64e(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#12bb64e")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#12bb64e");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#12bb64e",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction getDefaultBodyZoomAction_cde797(){
 if(context.get("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#cde797")!=null)
 return (nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction)context.get("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#cde797");
  nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction bean = new nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction();
  context.put("nc.ui.pubapp.uif2app.actions.DefaultBodyZoomAction#cde797",bean);
  bean.setPos(1);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList29(){  List list = new ArrayList();  list.add(getTermBAddLineAction_1fa770());  list.add(getTermBInsertLineAction_29cf0e());  list.add(getTermBDelLineAction_d8ab80());  list.add(getTermBCopyLineAction_e36a2a());  list.add(getTermBPasteLineAction_4f13dc());  return list;}

private nc.ui.ct.bodyaction.term.TermBAddLineAction getTermBAddLineAction_1fa770(){
 if(context.get("nc.ui.ct.bodyaction.term.TermBAddLineAction#1fa770")!=null)
 return (nc.ui.ct.bodyaction.term.TermBAddLineAction)context.get("nc.ui.ct.bodyaction.term.TermBAddLineAction#1fa770");
  nc.ui.ct.bodyaction.term.TermBAddLineAction bean = new nc.ui.ct.bodyaction.term.TermBAddLineAction();
  context.put("nc.ui.ct.bodyaction.term.TermBAddLineAction#1fa770",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.term.TermBInsertLineAction getTermBInsertLineAction_29cf0e(){
 if(context.get("nc.ui.ct.bodyaction.term.TermBInsertLineAction#29cf0e")!=null)
 return (nc.ui.ct.bodyaction.term.TermBInsertLineAction)context.get("nc.ui.ct.bodyaction.term.TermBInsertLineAction#29cf0e");
  nc.ui.ct.bodyaction.term.TermBInsertLineAction bean = new nc.ui.ct.bodyaction.term.TermBInsertLineAction();
  context.put("nc.ui.ct.bodyaction.term.TermBInsertLineAction#29cf0e",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.term.TermBDelLineAction getTermBDelLineAction_d8ab80(){
 if(context.get("nc.ui.ct.bodyaction.term.TermBDelLineAction#d8ab80")!=null)
 return (nc.ui.ct.bodyaction.term.TermBDelLineAction)context.get("nc.ui.ct.bodyaction.term.TermBDelLineAction#d8ab80");
  nc.ui.ct.bodyaction.term.TermBDelLineAction bean = new nc.ui.ct.bodyaction.term.TermBDelLineAction();
  context.put("nc.ui.ct.bodyaction.term.TermBDelLineAction#d8ab80",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.term.TermBCopyLineAction getTermBCopyLineAction_e36a2a(){
 if(context.get("nc.ui.ct.bodyaction.term.TermBCopyLineAction#e36a2a")!=null)
 return (nc.ui.ct.bodyaction.term.TermBCopyLineAction)context.get("nc.ui.ct.bodyaction.term.TermBCopyLineAction#e36a2a");
  nc.ui.ct.bodyaction.term.TermBCopyLineAction bean = new nc.ui.ct.bodyaction.term.TermBCopyLineAction();
  context.put("nc.ui.ct.bodyaction.term.TermBCopyLineAction#e36a2a",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.term.TermBPasteLineAction getTermBPasteLineAction_4f13dc(){
 if(context.get("nc.ui.ct.bodyaction.term.TermBPasteLineAction#4f13dc")!=null)
 return (nc.ui.ct.bodyaction.term.TermBPasteLineAction)context.get("nc.ui.ct.bodyaction.term.TermBPasteLineAction#4f13dc");
  nc.ui.ct.bodyaction.term.TermBPasteLineAction bean = new nc.ui.ct.bodyaction.term.TermBPasteLineAction();
  context.put("nc.ui.ct.bodyaction.term.TermBPasteLineAction#4f13dc",bean);
...
private List getManagedList30(){  List list = new ArrayList();  list.add(getExpBAddLineAction_1a0eb58());  list.add(getExpBInsertLineAction_1baf8e3());  list.add(getExpBDelLineAction_2a0412());  list.add(getExpBCopyLineAction_7163e2());  list.add(getExpBPasteLineAction_54ad88());  return list;}

private nc.ui.ct.bodyaction.exp.ExpBAddLineAction getExpBAddLineAction_1a0eb58(){
 if(context.get("nc.ui.ct.bodyaction.exp.ExpBAddLineAction#1a0eb58")!=null)
 return (nc.ui.ct.bodyaction.exp.ExpBAddLineAction)context.get("nc.ui.ct.bodyaction.exp.ExpBAddLineAction#1a0eb58");
  nc.ui.ct.bodyaction.exp.ExpBAddLineAction bean = new nc.ui.ct.bodyaction.exp.ExpBAddLineAction();
  context.put("nc.ui.ct.bodyaction.exp.ExpBAddLineAction#1a0eb58",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.exp.ExpBInsertLineAction getExpBInsertLineAction_1baf8e3(){
 if(context.get("nc.ui.ct.bodyaction.exp.ExpBInsertLineAction#1baf8e3")!=null)
 return (nc.ui.ct.bodyaction.exp.ExpBInsertLineAction)context.get("nc.ui.ct.bodyaction.exp.ExpBInsertLineAction#1baf8e3");
  nc.ui.ct.bodyaction.exp.ExpBInsertLineAction bean = new nc.ui.ct.bodyaction.exp.ExpBInsertLineAction();
  context.put("nc.ui.ct.bodyaction.exp.ExpBInsertLineAction#1baf8e3",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.exp.ExpBDelLineAction getExpBDelLineAction_2a0412(){
 if(context.get("nc.ui.ct.bodyaction.exp.ExpBDelLineAction#2a0412")!=null)
 return (nc.ui.ct.bodyaction.exp.ExpBDelLineAction)context.get("nc.ui.ct.bodyaction.exp.ExpBDelLineAction#2a0412");
  nc.ui.ct.bodyaction.exp.ExpBDelLineAction bean = new nc.ui.ct.bodyaction.exp.ExpBDelLineAction();
  context.put("nc.ui.ct.bodyaction.exp.ExpBDelLineAction#2a0412",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.exp.ExpBCopyLineAction getExpBCopyLineAction_7163e2(){
 if(context.get("nc.ui.ct.bodyaction.exp.ExpBCopyLineAction#7163e2")!=null)
 return (nc.ui.ct.bodyaction.exp.ExpBCopyLineAction)context.get("nc.ui.ct.bodyaction.exp.ExpBCopyLineAction#7163e2");
  nc.ui.ct.bodyaction.exp.ExpBCopyLineAction bean = new nc.ui.ct.bodyaction.exp.ExpBCopyLineAction();
  context.put("nc.ui.ct.bodyaction.exp.ExpBCopyLineAction#7163e2",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.exp.ExpBPasteLineAction getExpBPasteLineAction_54ad88(){
 if(context.get("nc.ui.ct.bodyaction.exp.ExpBPasteLineAction#54ad88")!=null)
 return (nc.ui.ct.bodyaction.exp.ExpBPasteLineAction)context.get("nc.ui.ct.bodyaction.exp.ExpBPasteLineAction#54ad88");
  nc.ui.ct.bodyaction.exp.ExpBPasteLineAction bean = new nc.ui.ct.bodyaction.exp.ExpBPasteLineAction();
  context.put("nc.ui.ct.bodyaction.exp.ExpBPasteLineAction#54ad88",bean);
...
private List getManagedList31(){  List list = new ArrayList();  list.add(getMemoraBAddLineAction_14cf555());  list.add(getMemoraBInsertLineAction_17ec405());  list.add(getMemoraBDelLineAction_1772b2e());  list.add(getMemoraBCopyLineAction_b4195c());  list.add(getMemoraBPasteLineAction_1ecf4b6());  return list;}

private nc.ui.ct.bodyaction.memora.MemoraBAddLineAction getMemoraBAddLineAction_14cf555(){
 if(context.get("nc.ui.ct.bodyaction.memora.MemoraBAddLineAction#14cf555")!=null)
 return (nc.ui.ct.bodyaction.memora.MemoraBAddLineAction)context.get("nc.ui.ct.bodyaction.memora.MemoraBAddLineAction#14cf555");
  nc.ui.ct.bodyaction.memora.MemoraBAddLineAction bean = new nc.ui.ct.bodyaction.memora.MemoraBAddLineAction();
  context.put("nc.ui.ct.bodyaction.memora.MemoraBAddLineAction#14cf555",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction getMemoraBInsertLineAction_17ec405(){
 if(context.get("nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction#17ec405")!=null)
 return (nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction)context.get("nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction#17ec405");
  nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction bean = new nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction();
  context.put("nc.ui.ct.bodyaction.memora.MemoraBInsertLineAction#17ec405",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.memora.MemoraBDelLineAction getMemoraBDelLineAction_1772b2e(){
 if(context.get("nc.ui.ct.bodyaction.memora.MemoraBDelLineAction#1772b2e")!=null)
 return (nc.ui.ct.bodyaction.memora.MemoraBDelLineAction)context.get("nc.ui.ct.bodyaction.memora.MemoraBDelLineAction#1772b2e");
  nc.ui.ct.bodyaction.memora.MemoraBDelLineAction bean = new nc.ui.ct.bodyaction.memora.MemoraBDelLineAction();
  context.put("nc.ui.ct.bodyaction.memora.MemoraBDelLineAction#1772b2e",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction getMemoraBCopyLineAction_b4195c(){
 if(context.get("nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction#b4195c")!=null)
 return (nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction)context.get("nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction#b4195c");
  nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction bean = new nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction();
  context.put("nc.ui.ct.bodyaction.memora.MemoraBCopyLineAction#b4195c",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction getMemoraBPasteLineAction_1ecf4b6(){
 if(context.get("nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction#1ecf4b6")!=null)
 return (nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction)context.get("nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction#1ecf4b6");
  nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction bean = new nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction();
  context.put("nc.ui.ct.bodyaction.memora.MemoraBPasteLineAction#1ecf4b6",bean);
...
private List getManagedList32(){  List list = new ArrayList();  list.add(getPaymentBAddLineAction_1b5ec2d());  list.add(getPaymentBInsertLineAction_a4b38c());  list.add(getPaymentBDelLineAction_107d9cb());  list.add(getPaymentBCopyLineAction_6bb16b());  list.add(getPaymentBPasteLineAction_4cfb81());  return list;}

private nc.ui.ct.bodyaction.payment.PaymentBAddLineAction getPaymentBAddLineAction_1b5ec2d(){
 if(context.get("nc.ui.ct.bodyaction.payment.PaymentBAddLineAction#1b5ec2d")!=null)
 return (nc.ui.ct.bodyaction.payment.PaymentBAddLineAction)context.get("nc.ui.ct.bodyaction.payment.PaymentBAddLineAction#1b5ec2d");
  nc.ui.ct.bodyaction.payment.PaymentBAddLineAction bean = new nc.ui.ct.bodyaction.payment.PaymentBAddLineAction();
  context.put("nc.ui.ct.bodyaction.payment.PaymentBAddLineAction#1b5ec2d",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction getPaymentBInsertLineAction_a4b38c(){
 if(context.get("nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction#a4b38c")!=null)
 return (nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction)context.get("nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction#a4b38c");
  nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction bean = new nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction();
  context.put("nc.ui.ct.bodyaction.payment.PaymentBInsertLineAction#a4b38c",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.payment.PaymentBDelLineAction getPaymentBDelLineAction_107d9cb(){
 if(context.get("nc.ui.ct.bodyaction.payment.PaymentBDelLineAction#107d9cb")!=null)
 return (nc.ui.ct.bodyaction.payment.PaymentBDelLineAction)context.get("nc.ui.ct.bodyaction.payment.PaymentBDelLineAction#107d9cb");
  nc.ui.ct.bodyaction.payment.PaymentBDelLineAction bean = new nc.ui.ct.bodyaction.payment.PaymentBDelLineAction();
  context.put("nc.ui.ct.bodyaction.payment.PaymentBDelLineAction#107d9cb",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction getPaymentBCopyLineAction_6bb16b(){
 if(context.get("nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction#6bb16b")!=null)
 return (nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction)context.get("nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction#6bb16b");
  nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction bean = new nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction();
  context.put("nc.ui.ct.bodyaction.payment.PaymentBCopyLineAction#6bb16b",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction getPaymentBPasteLineAction_4cfb81(){
 if(context.get("nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction#4cfb81")!=null)
 return (nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction)context.get("nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction#4cfb81");
  nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction bean = new nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction();
  context.put("nc.ui.ct.bodyaction.payment.PaymentBPasteLineAction#4cfb81",bean);
...
private List getManagedList34(){  List list = new ArrayList();  list.add(getUserdefQueryParam_1407a6());  list.add(getUserdefQueryParam_1022e9c());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_1407a6(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#1407a6")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#1407a6");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#1407a6",bean);
...
private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_1022e9c(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#1022e9c")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#1022e9c");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#1022e9c",bean);
...
private List getManagedList35(){  List list = new ArrayList();  list.add(getQueryParam_4243e2());  list.add(getQueryParam_76b7e5());  list.add(getQueryParam_23571f());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_4243e2(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#4243e2")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#4243e2");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#4243e2",bean);
  bean.setMdfullname("ct.ct_pu");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_76b7e5(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#76b7e5")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#76b7e5");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#76b7e5",bean);
  bean.setMdfullname("ct.ct_pu_b");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_23571f(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#23571f")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#23571f");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#23571f",bean);
...
private List getManagedList36(){  List list = new ArrayList();  list.add(getActionsBar_ActionsBarSeparator_2cc3ae());  list.add(getHeadZoomAction());  return list;}

private nc.ui.pub.beans.ActionsBar.ActionsBarSeparator getActionsBar_ActionsBarSeparator_2cc3ae(){
 if(context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#2cc3ae")!=null)
 return (nc.ui.pub.beans.ActionsBar.ActionsBarSeparator)context.get("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#2cc3ae");
  nc.ui.pub.beans.ActionsBar.ActionsBarSeparator bean = new nc.ui.pub.beans.ActionsBar.ActionsBarSeparator();
  context.put("nc.ui.pub.beans.ActionsBar.ActionsBarSeparator#2cc3ae",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setModel(getManageAppModel());
  bean.setTangramLayoutRoot(getTBNode_d2aaa8());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_d2aaa8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#d2aaa8")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#d2aaa8");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#d2aaa8",bean);
...
private List getManagedList37(){  List list = new ArrayList();  list.add(getHSNode_12aab40());  list.add(getVSNode_1eefbc2());  list.add(getListviewhistornode());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_12aab40(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#12aab40")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#12aab40");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#12aab40",bean);
  bean.setLeft(getCNode_e2e609());
  bean.setRight(getVSNode_11fce72());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_e2e609(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#e2e609")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#e2e609");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#e2e609",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_11fce72(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#11fce72")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#11fce72");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#11fce72",bean);
  bean.setUp(getCNode_6c6dd7());
  bean.setDown(getCNode_36e1c3());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_6c6dd7(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#6c6dd7")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#6c6dd7");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#6c6dd7",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_36e1c3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#36e1c3")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#36e1c3");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#36e1c3",bean);
  bean.setName(getI18nFB_9f6366());
...
private java.lang.String getI18nFB_9f6366(){
 if(context.get("nc.ui.uif2.I18nFB#9f6366")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#9f6366");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#9f6366",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#9f6366",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1eefbc2(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1eefbc2")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1eefbc2");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1eefbc2",bean);
  bean.setUp(getCNode_5133df());
  bean.setDown(getCNode_105299c());
  bean.setDividerLocation(25f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_5133df(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#5133df")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#5133df");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#5133df",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_105299c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#105299c")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#105299c");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#105299c",bean);
  bean.setName(getI18nFB_1247ede());
...
private java.lang.String getI18nFB_1247ede(){
 if(context.get("nc.ui.uif2.I18nFB#1247ede")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1247ede");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1247ede",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1247ede",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pubapp.billref.dest.TransferViewProcessor getTransferViewProcessor1(){
 ...
 return (nc.ui.pubapp.billref.dest.TransferViewProcessor)context.get("transferViewProcessor1");
  ...
  bean.setBillForm(getBillFormEditor());
  bean.setTransferLogic(getDefaultBillDataLogic_c20125());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.billref.dest.DefaultBillDataLogic getDefaultBillDataLogic_c20125(){
 if(context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#c20125")!=null)
 return (nc.ui.pubapp.billref.dest.DefaultBillDataLogic)context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#c20125");
  nc.ui.pubapp.billref.dest.DefaultBillDataLogic bean = new nc.ui.pubapp.billref.dest.DefaultBillDataLogic();
  context.put("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#c20125",bean);
  bean.setBillForm(getBillFormEditor());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList48(){  List list = new ArrayList();  list.add(getUserdefQueryParam_d92aae());  list.add(getUserdefQueryParam_1811033());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_d92aae(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#d92aae")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#d92aae");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#d92aae",bean);
  bean.setMdfullname("ct.ct_pu");
  bean.setPos(0);
  bean.setPrefix("vdef");
setBeanFacotryIfBeanFacatoryAware(bean);
...
private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_1811033(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#1811033")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#1811033");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#1811033",bean);
  bean.setMdfullname("ct.ct_pu_b");
  bean.setPos(1);
