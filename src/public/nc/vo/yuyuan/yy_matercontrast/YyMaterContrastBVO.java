...
public class YyMaterContrastBVO extends SuperVO {
	
/**
*子表主键
*/
public java.lang.String pk_matercontrast_b;
/**
*集团
*/
...
*配送方式
*/
public java.lang.String dispatchstyle;
/**
*上层单据主键
*/
public String pk_matercontrast;
/**
*时间戳
*/
...
/**
* 属性 pk_matercontrast_b的Getter方法.属性名：子表主键
*  创建日期:2017-1-5
* @return java.lang.String
*/
public java.lang.String getPk_matercontrast_b() {
return this.pk_matercontrast_b;
} 

/**
* 属性pk_matercontrast_b的Setter方法.属性名：子表主键
* 创建日期:2017-1-5
* @param newPk_matercontrast_b java.lang.String
*/
public void setPk_matercontrast_b ( java.lang.String pk_matercontrast_b) {
this.pk_matercontrast_b=pk_matercontrast_b;
} 
...
/**
* 属性 dispatchstyle的Getter方法.属性名：配送方式
*  创建日期:2017-1-5
* @return java.lang.String
*/
...
/**
* 属性dispatchstyle的Setter方法.属性名：配送方式
* 创建日期:2017-1-5
* @param newDispatchstyle java.lang.String
*/
public void setDispatchstyle ( java.lang.String dispatchstyle) {
...
* @return String
*/
public String getPk_matercontrast(){
return this.pk_matercontrast;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2017-1-5
* @param newPk_matercontrast String
*/
public void setPk_matercontrast(String pk_matercontrast){
this.pk_matercontrast=pk_matercontrast;
} 
/**
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("yuyuan.YyMaterContrastBVO");
    }
   }
