...
public class YyMaterContrastVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_matercontrast;
/**
*集团
*/
...
/**
* 属性 pk_matercontrast的Getter方法.属性名：主键
*  创建日期:2017-1-5
* @return java.lang.String
*/
public java.lang.String getPk_matercontrast() {
return this.pk_matercontrast;
} 

/**
* 属性pk_matercontrast的Setter方法.属性名：主键
* 创建日期:2017-1-5
* @param newPk_matercontrast java.lang.String
*/
public void setPk_matercontrast ( java.lang.String pk_matercontrast) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("yuyuan.YyMaterContrastVO");
    }
   }
