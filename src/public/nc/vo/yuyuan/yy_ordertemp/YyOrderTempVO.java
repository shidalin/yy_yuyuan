...
public class YyOrderTempVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_ordertemp;
/**
*集团
*/
...
*订货模板名称
*/
public java.lang.String ordertempname;
/**
*单据状态
*/
...
*模板失效日期
*/
public UFDate dinvalidate;
/**
*生效状态
*/
public UFBoolean fproduceflag;
/**
*时间戳
*/
...
/**
* 属性 pk_ordertemp的Getter方法.属性名：主键
*  创建日期:2017-1-5
* @return java.lang.String
*/
public java.lang.String getPk_ordertemp() {
return this.pk_ordertemp;
} 

/**
* 属性pk_ordertemp的Setter方法.属性名：主键
* 创建日期:2017-1-5
* @param newPk_ordertemp java.lang.String
*/
public void setPk_ordertemp ( java.lang.String pk_ordertemp) {
...
/**
* 属性 vbillcode的Getter方法.属性名：订货模板号
*  创建日期:2017-1-5
* @return java.lang.String
*/
...
/**
* 属性vbillcode的Setter方法.属性名：订货模板号
* 创建日期:2017-1-5
...
/**
* 属性 ordertempname的Getter方法.属性名：订货模板名称
*  创建日期:2017-1-5
* @return java.lang.String
*/
public java.lang.String getOrdertempname() {
return this.ordertempname;
} 

/**
* 属性ordertempname的Setter方法.属性名：订货模板名称
* 创建日期:2017-1-5
* @param newOrdertempname java.lang.String
*/
public void setOrdertempname ( java.lang.String ordertempname) {
...
/**
* 属性 dproducedate的Getter方法.属性名：模板生产日期
*  创建日期:2017-1-5
* @return nc.vo.pub.lang.UFDate
*/
...
/**
* 属性dproducedate的Setter方法.属性名：模板生产日期
* 创建日期:2017-1-5
...
/**
* 属性 dinvalidate的Getter方法.属性名：模板失效日期
*  创建日期:2017-1-5
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getDinvalidate() {
return this.dinvalidate;
} 

/**
* 属性dinvalidate的Setter方法.属性名：模板失效日期
* 创建日期:2017-1-5
* @param newDinvalidate nc.vo.pub.lang.UFDate
*/
public void setDinvalidate ( UFDate dinvalidate) {
this.dinvalidate=dinvalidate;
} 
 
/**
* 属性 fproduceflag的Getter方法.属性名：生效状态
*  创建日期:2017-1-5
* @return nc.vo.pub.lang.UFBoolean
*/
public UFBoolean getFproduceflag() {
return this.fproduceflag;
} 

/**
* 属性fproduceflag的Setter方法.属性名：生效状态
* 创建日期:2017-1-5
* @param newFproduceflag nc.vo.pub.lang.UFBoolean
*/
public void setFproduceflag ( UFBoolean fproduceflag) {
this.fproduceflag=fproduceflag;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("yuyuan.YyOrderTempVO");
    }
   }
