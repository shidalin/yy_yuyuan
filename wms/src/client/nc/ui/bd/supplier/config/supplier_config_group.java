...
public class supplier_config_group extends AbstractJavaBeanDefinition{
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryParam_e9eed8());  list.add(getQueryParam_3fb3af());  list.add(getQueryParam_2db9c7());  list.add(getQueryParam_1ffc852());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_e9eed8(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#e9eed8")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#e9eed8");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#e9eed8",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_3fb3af(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#3fb3af")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#3fb3af");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#3fb3af",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_2db9c7(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#2db9c7")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#2db9c7");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#2db9c7",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1ffc852(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1ffc852")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1ffc852");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1ffc852",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1d42254());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1d42254(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1d42254")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1d42254");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1d42254",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getHSNode_ab0a8b());  list.add(getVSNode_1e5a57e());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_ab0a8b(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#ab0a8b")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#ab0a8b");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#ab0a8b",bean);
  bean.setLeft(getCNode_1b88cd3());
  bean.setRight(getCNode_125a5d8());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1b88cd3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1b88cd3")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1b88cd3");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1b88cd3",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_125a5d8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#125a5d8")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#125a5d8");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#125a5d8",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1e5a57e(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1e5a57e")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1e5a57e");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1e5a57e",bean);
  bean.setUp(getCNode_1416263());
  bean.setDown(getVSNode_137bb3d());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1416263(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1416263")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1416263");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1416263",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_137bb3d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#137bb3d")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#137bb3d");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#137bb3d",bean);
  bean.setUp(getCNode_1a25340());
  bean.setDown(getTBNode_d40397());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1a25340(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1a25340")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1a25340");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1a25340",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_d40397(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#d40397")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#d40397");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#d40397",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getCNode_1c19f95());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1c19f95(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1c19f95")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1c19f95");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1c19f95",bean);
  bean.setName(getI18nFB_7ac4f());
...
private java.lang.String getI18nFB_7ac4f(){
 if(context.get("nc.ui.uif2.I18nFB#7ac4f")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#7ac4f");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#7ac4f",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#7ac4f",product);
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_19da8f());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_19da8f(){
 if(context.get("bdqueryActionBaseMediator.created#19da8f")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#19da8f");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#19da8f",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView getBaseinfoListView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView)context.get("baseinfoListView");
  ...
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_15c0a58());
...
private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_15c0a58(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#15c0a58")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#15c0a58");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#15c0a58",bean);
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView getBaseinfoCardView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView)context.get("baseinfoCardView");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setNodekey("base");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_1ab1921());
  bean.setExceptionHandler(getExceptionhandler());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_1ab1921(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1ab1921")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1ab1921");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#1ab1921",bean);
  bean.setContainer(getUserdefitemContainer());
...
private List getManagedList11(){  List list = new ArrayList();  list.add(getAddLineAction_1fecd90());  list.add(getInsertLineAction_169be7a());  list.add(getDelLineAction_1584798());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1fecd90(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1fecd90")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1fecd90");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1fecd90",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_169be7a(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#169be7a")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#169be7a");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#169be7a",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1584798(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1584798")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1584798");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1584798",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getAddLineAction_c45c3b());  list.add(getInsertLineAction_1835511());  list.add(getDelLineAction_1460014());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_c45c3b(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#c45c3b")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#c45c3b");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#c45c3b",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_1835511(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#1835511")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#1835511");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#1835511",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1460014(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1460014")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1460014");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1460014",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_af3530(){
 if(context.get("nc.ui.uif2.I18nFB#af3530")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#af3530");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#af3530",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#af3530",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAction getList_searchAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("list_searchAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_cd15f4());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_cd15f4(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#cd15f4")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#cd15f4");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#cd15f4",bean);
  bean.setContext(getContext());
...
private List getManagedList19(){  List list = new ArrayList();  list.add(getSupBaseInfoBatchUpdateTab_5c5c1f());  list.add(getSupFinanceBatchUpdateTab_1a43808());  list.add(getSupStockBatchUpdateTab_5ac74c());  return list;}

private nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab getSupBaseInfoBatchUpdateTab_5c5c1f(){
 if(context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#5c5c1f")!=null)
 return (nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab)context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#5c5c1f");
  nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab bean = new nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab();
  context.put("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#5c5c1f",bean);
...
private nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab getSupFinanceBatchUpdateTab_1a43808(){
 if(context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1a43808")!=null)
 return (nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab)context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1a43808");
  nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab bean = new nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab();
  context.put("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#1a43808",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.stock.SupStockBatchUpdateTab getSupStockBatchUpdateTab_5ac74c(){
 if(context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#5ac74c")!=null)
 return (nc.ui.bd.supplier.stock.SupStockBatchUpdateTab)context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#5ac74c");
  nc.ui.bd.supplier.stock.SupStockBatchUpdateTab bean = new nc.ui.bd.supplier.stock.SupStockBatchUpdateTab();
  context.put("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#5ac74c",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu");
  ...
  bean.setName(getI18nFB_1d2820d());
...
private java.lang.String getI18nFB_1d2820d(){
 if(context.get("nc.ui.uif2.I18nFB#1d2820d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1d2820d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1d2820d",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1d2820d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList25(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_1582570());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_1582570(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1582570")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1582570");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#1582570",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_21632());
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
  bean.setSaveAction(getAssociCustSaveAction());
  bean.setCancelAction(getCancelAction_ff56ae());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_21632(){
 if(context.get("nc.ui.uif2.I18nFB#21632")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#21632");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#21632",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#21632",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.actions.CancelAction getCancelAction_ff56ae(){
 if(context.get("nc.ui.uif2.actions.CancelAction#ff56ae")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#ff56ae");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#ff56ae",bean);
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getCreateVCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("createVCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_193bd18());
...
private java.lang.String getI18nFB_193bd18(){
 if(context.get("nc.ui.uif2.I18nFB#193bd18")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#193bd18");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#193bd18",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#193bd18",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction getCreateCustSaveAction(){
 ...
 return (nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction)context.get("createCustSaveAction");
  ...
  bean.setModel(getCreateViewModel());
  bean.setValidationService(getSupplierValidationService_63a6c1());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.baseinfo.model.SupplierValidationService getSupplierValidationService_63a6c1(){
 if(context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#63a6c1")!=null)
 return (nc.ui.bd.supplier.baseinfo.model.SupplierValidationService)context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#63a6c1");
  ...
  context.put("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#63a6c1",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_58ed01());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_58ed01(){
 if(context.get("nc.ui.uif2.I18nFB#58ed01")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#58ed01");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#58ed01",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#58ed01",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pubapp.plugin.action.ActionInterceptorInfo getActionInterceptorInfo_0(){
 ...
 return (nc.ui.pubapp.plugin.action.ActionInterceptorInfo)context.get("nc.ui.pubapp.plugin.action.ActionInterceptorInfo#0");
  ...
  bean.setTarget((nc.ui.uif2.NCAction)findBeanInUIF2BeanFactory("deleteAction"));
...
public nc.ui.bd.supplier.ace.interceptor.InterceptorForDeleteAction getInterceptorForDeleteAction(){
 if(context.get("interceptorForDeleteAction")!=null)
 return (nc.ui.bd.supplier.ace.interceptor.InterceptorForDeleteAction)context.get("interceptorForDeleteAction");
  nc.ui.bd.supplier.ace.interceptor.InterceptorForDeleteAction bean = new nc.ui.bd.supplier.ace.interceptor.InterceptorForDeleteAction();
...
public nc.ui.bd.supplier.ace.interceptor.SendToWMSAction getSendToWMSAction(){
 if(context.get("sendToWMSAction")!=null)
 return (nc.ui.bd.supplier.ace.interceptor.SendToWMSAction)context.get("sendToWMSAction");
  nc.ui.bd.supplier.ace.interceptor.SendToWMSAction bean = new nc.ui.bd.supplier.ace.interceptor.SendToWMSAction();
