...
public class supplier_config_org extends AbstractJavaBeanDefinition{
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryParam_1056ef0());  list.add(getQueryParam_118c067());  list.add(getQueryParam_27c8());  list.add(getQueryParam_1e617a7());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1056ef0(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1056ef0")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1056ef0");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1056ef0",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_118c067(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#118c067")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#118c067");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#118c067",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_27c8(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#27c8")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#27c8");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#27c8",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1e617a7(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1e617a7")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1e617a7");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1e617a7",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_41912());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_41912(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#41912")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#41912");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#41912",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getHSNode_1a737d7());  list.add(getVSNode_15ef348());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_1a737d7(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#1a737d7")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#1a737d7");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#1a737d7",bean);
  bean.setLeft(getCNode_1708c05());
  bean.setRight(getCNode_6474b4());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1708c05(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1708c05")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1708c05");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1708c05",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_6474b4(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#6474b4")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#6474b4");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#6474b4",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_15ef348(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#15ef348")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#15ef348");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#15ef348",bean);
  bean.setUp(getCNode_f1462b());
  bean.setDown(getVSNode_7df870());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_f1462b(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#f1462b")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#f1462b");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#f1462b",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_7df870(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#7df870")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#7df870");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#7df870",bean);
  bean.setUp(getCNode_1bcf654());
  bean.setDown(getTBNode_efa66f());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_1bcf654(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1bcf654")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1bcf654");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1bcf654",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_efa66f(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#efa66f")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#efa66f");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#efa66f",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getCNode_836bca());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_836bca(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#836bca")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#836bca");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#836bca",bean);
  bean.setName(getI18nFB_88ec43());
...
private java.lang.String getI18nFB_88ec43(){
 if(context.get("nc.ui.uif2.I18nFB#88ec43")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#88ec43");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#88ec43",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#88ec43",product);
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_19507e3());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_19507e3(){
 if(context.get("bdqueryActionBaseMediator.created#19507e3")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#19507e3");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#19507e3",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView getBaseinfoListView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView)context.get("baseinfoListView");
  ...
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_68d419());
...
private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_68d419(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#68d419")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#68d419");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#68d419",bean);
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView getBaseinfoCardView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView)context.get("baseinfoCardView");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setNodekey("base");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_3ebe6f());
  bean.setExceptionHandler(getExceptionhandler());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_3ebe6f(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#3ebe6f")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#3ebe6f");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#3ebe6f",bean);
  bean.setContainer(getUserdefitemContainer());
...
private List getManagedList11(){  List list = new ArrayList();  list.add(getAddLineAction_30f433());  list.add(getInsertLineAction_19d5649());  list.add(getDelLineAction_1ff953f());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_30f433(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#30f433")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#30f433");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#30f433",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_19d5649(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#19d5649")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#19d5649");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#19d5649",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_1ff953f(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#1ff953f")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#1ff953f");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#1ff953f",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getAddLineAction_b99ca9());  list.add(getInsertLineAction_11372a1());  list.add(getDelLineAction_6d57d4());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_b99ca9(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#b99ca9")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#b99ca9");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#b99ca9",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_11372a1(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#11372a1")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#11372a1");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#11372a1",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_6d57d4(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#6d57d4")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#6d57d4");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#6d57d4",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.funcnode.ui.action.MenuAction getFilterAction(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("filterAction");
  ...
  bean.setCode("filter");
  bean.setName(getI18nFB_1d6728b());
...
private java.lang.String getI18nFB_1d6728b(){
 if(context.get("nc.ui.uif2.I18nFB#1d6728b")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1d6728b");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1d6728b",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1d6728b",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAction getList_searchAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("list_searchAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getBusinessUnitOnlyQueryDelegator_1c22f54());
...
private nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator getBusinessUnitOnlyQueryDelegator_1c22f54(){
 if(context.get("nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator#1c22f54")!=null)
 return (nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator)context.get("nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator#1c22f54");
  nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator bean = new nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator();
  context.put("nc.ui.bd.pub.query.BusinessUnitOnlyQueryDelegator#1c22f54",bean);
  bean.setContext(getContext());
  bean.setReplaceRefModelFields(getManagedList14());
  bean.setTemplateContainer(getQueryTemplateContainer());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList14(){  List list = new ArrayList();  list.add("pk_org_assign");  return list;}
...
private List getManagedList15(){  List list = new ArrayList();  list.add(getList_approveAction());  list.add(getList_disapproveAction());  return list;}
...
private List getManagedList16(){  List list = new ArrayList();  list.add(getFreezeAction());  list.add(getUnFreezeAction());  return list;}
...
private List getManagedList18(){  List list = new ArrayList();  list.add("BUSINESSUNIT00000000");  return list;}
...
private List getManagedList19(){  List list = new ArrayList();  list.add(getBatchUpdateAction());  list.add(getBatchUpdateWizardAction());  return list;}
...
private List getManagedList20(){  List list = new ArrayList();  list.add(getSupBaseInfoBatchUpdateTab_1600cec());  list.add(getSupFinanceBatchUpdateTab_12926e3());  list.add(getSupStockBatchUpdateTab_1c55327());  return list;}

private nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab getSupBaseInfoBatchUpdateTab_1600cec(){
 if(context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1600cec")!=null)
 return (nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab)context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1600cec");
  nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab bean = new nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab();
  context.put("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#1600cec",bean);
...
private nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab getSupFinanceBatchUpdateTab_12926e3(){
 if(context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12926e3")!=null)
 return (nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab)context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12926e3");
  nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab bean = new nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab();
  context.put("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#12926e3",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.stock.SupStockBatchUpdateTab getSupStockBatchUpdateTab_1c55327(){
 if(context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1c55327")!=null)
 return (nc.ui.bd.supplier.stock.SupStockBatchUpdateTab)context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1c55327");
  nc.ui.bd.supplier.stock.SupStockBatchUpdateTab bean = new nc.ui.bd.supplier.stock.SupStockBatchUpdateTab();
  context.put("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1c55327",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private List getManagedList21(){  List list = new ArrayList();  list.add(getBaseinfoenableaction());  list.add(getBaseinfodisableaction());  return list;}
...
private List getManagedList22(){  List list = new ArrayList();  list.add(getList_templatePrint());  list.add(getList_templatePreview());  list.add(getList_outoutAction());  return list;}
...
private List getManagedList23(){  List list = new ArrayList();  list.add(getCard_templatePrint());  list.add(getCard_templatePreview());  list.add(getCard_outputAction());  return list;}
...
public nc.funcnode.ui.action.MenuAction getAssistantFuncMenu(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("assistantFuncMenu");
  ...
  bean.setName(getI18nFB_17fd44a());
...
private java.lang.String getI18nFB_17fd44a(){
 if(context.get("nc.ui.uif2.I18nFB#17fd44a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#17fd44a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#17fd44a",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#17fd44a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList24(){  List list = new ArrayList();  list.add(getCreateCustAction());  list.add(getAssociCustAction());  list.add(getAccessoryAction());  return list;}
...
private List getManagedList25(){  List list = new ArrayList();  list.add(getManageModeActionInterceptor());  list.add(getBdSaveActionInterceptor());  return list;}
...
public nc.bs.uif2.validation.DefaultValidationService getSaveValidation(){
 ...
 return (nc.bs.uif2.validation.DefaultValidationService)context.get("saveValidation");
  ...
  bean.setValidators(getManagedList26());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private List getManagedList26(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_9a2e5());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_9a2e5(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#9a2e5")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#9a2e5");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#9a2e5",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private List getManagedList27(){  List list = new ArrayList();  list.add(getCard_approveaction());  list.add(getCard_unapproveaction());  return list;}
...
private List getManagedList28(){  List list = new ArrayList();  list.add(getFreezeAction());  list.add(getUnFreezeAction());  return list;}
...
private List getManagedList29(){  List list = new ArrayList();  list.add(getCard_enableaction());  list.add(getCard_disableaction());  return list;}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_b59139());
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
  bean.setSaveAction(getAssociCustSaveAction());
  bean.setCancelAction(getCancelAction_186a123());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_b59139(){
 if(context.get("nc.ui.uif2.I18nFB#b59139")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#b59139");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#b59139",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#b59139",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.actions.CancelAction getCancelAction_186a123(){
 if(context.get("nc.ui.uif2.actions.CancelAction#186a123")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#186a123");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#186a123",bean);
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_4cf25d(){
 if(context.get("nc.ui.uif2.I18nFB#4cf25d")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#4cf25d");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#4cf25d",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#4cf25d",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction getCreateCustSaveAction(){
 ...
 return (nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction)context.get("createCustSaveAction");
  ...
  bean.setModel(getCreateViewModel());
  bean.setValidationService(getSupplierValidationService_1876e7b());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.baseinfo.model.SupplierValidationService getSupplierValidationService_1876e7b(){
 if(context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1876e7b")!=null)
 return (nc.ui.bd.supplier.baseinfo.model.SupplierValidationService)context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1876e7b");
  ...
  context.put("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1876e7b",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_12d19eb());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_12d19eb(){
 if(context.get("nc.ui.uif2.I18nFB#12d19eb")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#12d19eb");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#12d19eb",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#12d19eb",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList30(){  List list = new ArrayList();  list.add("pk_org_assign");  return list;}
...
public nc.ui.uif2.actions.StandAloneToftPanelActionContainer getBaseinfoCardViewActions(){
 ...
 return (nc.ui.uif2.actions.StandAloneToftPanelActionContainer)context.get("baseinfoCardViewActions");
  ...
  bean.setEditActions(getManagedList33());
  bean.setModel(getBaseinfoModel());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
