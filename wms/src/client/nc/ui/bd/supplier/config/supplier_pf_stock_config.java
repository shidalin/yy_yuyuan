...
public class supplier_pf_stock_config extends AbstractJavaBeanDefinition{
...
private List getManagedList0(){  List list = new ArrayList();  list.add(getSupStockEditAction());  list.add(getStockSeparatorAction());  list.add(getSupStockRefreshAction());  return list;}
...
private List getManagedList1(){  List list = new ArrayList();  list.add(getQueryParam_894b58());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_894b58(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#894b58")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#894b58");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#894b58",bean);
...
public nc.ui.bd.pub.orginfo.model.DefaultAppPFModelDataManager getSupStockModelDataManager(){
 if(context.get("SupStockModelDataManager")!=null)
 return (nc.ui.bd.pub.orginfo.model.DefaultAppPFModelDataManager)context.get("SupStockModelDataManager");
  ...
  bean.setOrgModel(getSupStockAppModel());
  bean.setBaseModel((nc.ui.uif2.model.AbstractUIAppModel)findBeanInUIF2BeanFactory("baseinfoModel"));
  bean.setExbeanname("supplier_stock");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.bd.pub.orginfo.model.PFOrgInfoMediator getSupStockMediator(){
 if(context.get("supStockMediator")!=null)
 return (nc.ui.bd.pub.orginfo.model.PFOrgInfoMediator)context.get("supStockMediator");
  ...
  bean.setBaseModel((nc.ui.uif2.model.AbstractUIAppModel)findBeanInUIF2BeanFactory("baseinfoModel"));
  bean.setPfModelDataManager(getSupStockModelDataManager());
...
public nc.ui.bd.supplier.stock.view.SupStockListView getSupStockListView(){
 ...
 return (nc.ui.bd.supplier.stock.view.SupStockListView)context.get("supStockListView");
  ...
  bean.setName(getI18nFB_19dadf6());
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_1527a40());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_19dadf6(){
 if(context.get("nc.ui.uif2.I18nFB#19dadf6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#19dadf6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#19dadf6",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#19dadf6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_1527a40(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1527a40")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1527a40");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#1527a40",bean);
  bean.setContainer((nc.ui.uif2.userdefitem.UserDefItemContainer)findBeanInUIF2BeanFactory("userdefitemContainer"));
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getUserdefQueryParam_bf8dc5());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_bf8dc5(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#bf8dc5")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#bf8dc5");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#bf8dc5",bean);
  bean.setMdfullname("uap.supstock");
  bean.setPos(0);
  bean.setPrefix("def");
setBeanFacotryIfBeanFacatoryAware(bean);
...
public nc.ui.bd.supplier.stock.view.SupplierStockView getSupStockInfoView(){
 ...
 return (nc.ui.bd.supplier.stock.view.SupplierStockView)context.get("SupStockInfoView");
  ...
  bean.setTemplateContainer((nc.ui.uif2.editor.TemplateContainer)findBeanInUIF2BeanFactory("templateContainer"));
  bean.setNodekey("stock");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_1c208d4());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_1c208d4(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1c208d4")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#1c208d4");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#1c208d4",bean);
  bean.setContainer((nc.ui.uif2.userdefitem.UserDefItemContainer)findBeanInUIF2BeanFactory("userdefitemContainer"));
...
private List getManagedList3(){  List list = new ArrayList();  list.add(getUserdefQueryParam_10ccb4e());  return list;}

private nc.ui.uif2.editor.UserdefQueryParam getUserdefQueryParam_10ccb4e(){
 if(context.get("nc.ui.uif2.editor.UserdefQueryParam#10ccb4e")!=null)
 return (nc.ui.uif2.editor.UserdefQueryParam)context.get("nc.ui.uif2.editor.UserdefQueryParam#10ccb4e");
  nc.ui.uif2.editor.UserdefQueryParam bean = new nc.ui.uif2.editor.UserdefQueryParam();
  context.put("nc.ui.uif2.editor.UserdefQueryParam#10ccb4e",bean);
  bean.setMdfullname("uap.supstock");
  bean.setPos(0);
  bean.setPrefix("def");
setBeanFacotryIfBeanFacatoryAware(bean);
...
public nc.ui.bd.pub.orginfo.model.OrgInfoCardDialogMediator getSupStockDialogMediator(){
 ...
 return (nc.ui.bd.pub.orginfo.model.OrgInfoCardDialogMediator)context.get("supStockDialogMediator");
  ...
  bean.setName(getI18nFB_162b6a8());
  bean.setClosingListener(getSupStockClosingListener());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_162b6a8(){
 if(context.get("nc.ui.uif2.I18nFB#162b6a8")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#162b6a8");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#162b6a8",bean);  bean.setResDir("10140sub");
  bean.setDefaultValue("采购信息");
  bean.setResId("110140sub0008");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#162b6a8",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList6(){  List list = new ArrayList();  list.add(getTangramLayoutConstraint_c8b8c6());  return list;}

private nc.ui.uif2.tangramlayout.TangramLayoutConstraint getTangramLayoutConstraint_c8b8c6(){
 if(context.get("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#c8b8c6")!=null)
 return (nc.ui.uif2.tangramlayout.TangramLayoutConstraint)context.get("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#c8b8c6");
  nc.ui.uif2.tangramlayout.TangramLayoutConstraint bean = new nc.ui.uif2.tangramlayout.TangramLayoutConstraint();
  context.put("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#c8b8c6",bean);
  bean.setNewComponent(getSupStockInfoView());
  bean.setNewComponentName(getI18nFB_93818a());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_93818a(){
 if(context.get("nc.ui.uif2.I18nFB#93818a")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#93818a");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#93818a",bean);  bean.setResDir("10140sub");
  bean.setDefaultValue("采购信息");
  bean.setResId("110140sub0008");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#93818a",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private List getManagedList7(){  List list = new ArrayList();  list.add(getSupStockEditAction());  list.add(getStockSeparatorAction());  list.add(getSupStockRefreshSingleAction());  return list;}
...
public nc.ui.bd.supplier.pf.action.SupplierPfOrgTabEditAction getSupStockEditAction(){
 if(context.get("SupStockEditAction")!=null)
 return (nc.ui.bd.supplier.pf.action.SupplierPfOrgTabEditAction)context.get("SupStockEditAction");
...
public nc.ui.bd.supplier.pf.action.SupplierPfOrgTabSaveAction getSupStockSaveAction(){
 if(context.get("SupStockSaveAction")!=null)
 return (nc.ui.bd.supplier.pf.action.SupplierPfOrgTabSaveAction)context.get("SupStockSaveAction");
