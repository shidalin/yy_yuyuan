...
public class supplier_orgbrowse_config extends AbstractJavaBeanDefinition{
...
public nc.ui.bd.uitabextend.ExinfoLoader getExinfoloader(){
 ...
 return (nc.ui.bd.uitabextend.ExinfoLoader)context.get("exinfoloader");
  ...
  bean.setCurrent_md_ID("10140SOB");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_171b2d3());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_171b2d3(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#171b2d3")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#171b2d3");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#171b2d3",bean);
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getCNode_191ea2a());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_191ea2a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#191ea2a")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#191ea2a");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#191ea2a",bean);
