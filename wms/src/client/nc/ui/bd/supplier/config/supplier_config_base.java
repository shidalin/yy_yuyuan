...
public class supplier_config_base extends AbstractJavaBeanDefinition{
...
private List getManagedList2(){  List list = new ArrayList();  list.add(getQueryParam_1babcb1());  list.add(getQueryParam_487594());  list.add(getQueryParam_1457f15());  list.add(getQueryParam_1f87767());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1babcb1(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1babcb1")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1babcb1");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1babcb1",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_487594(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#487594")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#487594");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#487594",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1457f15(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1457f15")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1457f15");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1457f15",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_1f87767(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#1f87767")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#1f87767");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#1f87767",bean);
...
private List getManagedList3(){  List list = new ArrayList();  list.add((nc.ui.uif2.actions.IActionContributor)findBeanInUIF2BeanFactory("baseinfoListViewActions"));  list.add((nc.ui.uif2.actions.IActionContributor)findBeanInUIF2BeanFactory("baseinfoCardViewActions"));  return list;}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getTBNode_1bd16c0());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_1bd16c0(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#1bd16c0")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#1bd16c0");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#1bd16c0",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getHSNode_ef447a());  list.add(getVSNode_c2d816());  return list;}

private nc.ui.uif2.tangramlayout.node.HSNode getHSNode_ef447a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.HSNode#ef447a")!=null)
 return (nc.ui.uif2.tangramlayout.node.HSNode)context.get("nc.ui.uif2.tangramlayout.node.HSNode#ef447a");
  nc.ui.uif2.tangramlayout.node.HSNode bean = new nc.ui.uif2.tangramlayout.node.HSNode();
  context.put("nc.ui.uif2.tangramlayout.node.HSNode#ef447a",bean);
  bean.setLeft(getCNode_195075d());
  bean.setRight(getCNode_b42bee());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_195075d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#195075d")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#195075d");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#195075d",bean);
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_b42bee(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#b42bee")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#b42bee");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#b42bee",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_c2d816(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#c2d816")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#c2d816");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#c2d816",bean);
  bean.setUp(getCNode_b251cf());
  bean.setDown(getVSNode_17abf8d());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_b251cf(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#b251cf")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#b251cf");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#b251cf",bean);
...
private nc.ui.uif2.tangramlayout.node.VSNode getVSNode_17abf8d(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#17abf8d")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#17abf8d");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#17abf8d",bean);
  bean.setUp(getCNode_15a0b2b());
  bean.setDown(getTBNode_3cf2f2());
  bean.setDividerLocation(30f);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_15a0b2b(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#15a0b2b")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#15a0b2b");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#15a0b2b",bean);
...
private nc.ui.uif2.tangramlayout.node.TBNode getTBNode_3cf2f2(){
 if(context.get("nc.ui.uif2.tangramlayout.node.TBNode#3cf2f2")!=null)
 return (nc.ui.uif2.tangramlayout.node.TBNode)context.get("nc.ui.uif2.tangramlayout.node.TBNode#3cf2f2");
  nc.ui.uif2.tangramlayout.node.TBNode bean = new nc.ui.uif2.tangramlayout.node.TBNode();
  context.put("nc.ui.uif2.tangramlayout.node.TBNode#3cf2f2",bean);
...
private List getManagedList5(){  List list = new ArrayList();  list.add(getCNode_40f21c());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_40f21c(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#40f21c")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#40f21c");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#40f21c",bean);
  bean.setName(getI18nFB_3aa935());
...
private java.lang.String getI18nFB_3aa935(){
 if(context.get("nc.ui.uif2.I18nFB#3aa935")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#3aa935");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#3aa935",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#3aa935",product);
...
public nc.ui.uif2.actions.QueryAreaShell getQueryAreaShell(){
 ...
 return (nc.ui.uif2.actions.QueryAreaShell)context.get("queryAreaShell");
  ...
  bean.setQueryArea(getBdqueryActionBaseMediator_created_19c667());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private nc.ui.queryarea.QueryArea getBdqueryActionBaseMediator_created_19c667(){
 if(context.get("bdqueryActionBaseMediator.created#19c667")!=null)
 return (nc.ui.queryarea.QueryArea)context.get("bdqueryActionBaseMediator.created#19c667");
  nc.ui.queryarea.QueryArea bean = getBdqueryActionBaseMediator().createQueryArea();
  context.put("bdqueryActionBaseMediator.created#19c667",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView getBaseinfoListView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoListView)context.get("baseinfoListView");
  ...
  bean.setUserdefitemListPreparator(getUserdefitemContainerListPreparator_e78ffe());
...
private nc.ui.uif2.editor.UserdefitemContainerListPreparator getUserdefitemContainerListPreparator_e78ffe(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#e78ffe")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerListPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerListPreparator#e78ffe");
  nc.ui.uif2.editor.UserdefitemContainerListPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerListPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerListPreparator#e78ffe",bean);
...
public nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView getBaseinfoCardView(){
 ...
 return (nc.ui.bd.supplier.baseinfo.view.SupplierBaseInfoCardView)context.get("baseinfoCardView");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setNodekey("base");
  bean.setUserdefitemPreparator(getUserdefitemContainerPreparator_95f25c());
  bean.setExceptionHandler(getExceptionhandler());
...
private nc.ui.uif2.editor.UserdefitemContainerPreparator getUserdefitemContainerPreparator_95f25c(){
 if(context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#95f25c")!=null)
 return (nc.ui.uif2.editor.UserdefitemContainerPreparator)context.get("nc.ui.uif2.editor.UserdefitemContainerPreparator#95f25c");
  nc.ui.uif2.editor.UserdefitemContainerPreparator bean = new nc.ui.uif2.editor.UserdefitemContainerPreparator();
  context.put("nc.ui.uif2.editor.UserdefitemContainerPreparator#95f25c",bean);
  bean.setContainer(getUserdefitemContainer());
...
private List getManagedList11(){  List list = new ArrayList();  list.add(getAddLineAction_1bff658());  list.add(getInsertLineAction_19d3f36());  list.add(getDelLineAction_187c444());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_1bff658(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#1bff658")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#1bff658");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#1bff658",bean);
  bean.setModel(getBaseinfoModel());
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_19d3f36(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#19d3f36")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#19d3f36");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#19d3f36",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_187c444(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#187c444")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#187c444");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#187c444",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private List getManagedList12(){  List list = new ArrayList();  list.add(getAddLineAction_e1ddba());  list.add(getInsertLineAction_fce648());  list.add(getDelLineAction_960f6e());  return list;}

private nc.ui.uif2.actions.AddLineAction getAddLineAction_e1ddba(){
 if(context.get("nc.ui.uif2.actions.AddLineAction#e1ddba")!=null)
 return (nc.ui.uif2.actions.AddLineAction)context.get("nc.ui.uif2.actions.AddLineAction#e1ddba");
  nc.ui.uif2.actions.AddLineAction bean = new nc.ui.uif2.actions.AddLineAction();
  context.put("nc.ui.uif2.actions.AddLineAction#e1ddba",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.InsertLineAction getInsertLineAction_fce648(){
 if(context.get("nc.ui.uif2.actions.InsertLineAction#fce648")!=null)
 return (nc.ui.uif2.actions.InsertLineAction)context.get("nc.ui.uif2.actions.InsertLineAction#fce648");
  nc.ui.uif2.actions.InsertLineAction bean = new nc.ui.uif2.actions.InsertLineAction();
  context.put("nc.ui.uif2.actions.InsertLineAction#fce648",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private nc.ui.uif2.actions.DelLineAction getDelLineAction_960f6e(){
 if(context.get("nc.ui.uif2.actions.DelLineAction#960f6e")!=null)
 return (nc.ui.uif2.actions.DelLineAction)context.get("nc.ui.uif2.actions.DelLineAction#960f6e");
  nc.ui.uif2.actions.DelLineAction bean = new nc.ui.uif2.actions.DelLineAction();
  context.put("nc.ui.uif2.actions.DelLineAction#960f6e",bean);
  bean.setModel(getBaseinfoModel());
  bean.setCardpanel(getBaseinfoCardView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
public nc.funcnode.ui.action.MenuAction getFilterAction(){
 ...
 return (nc.funcnode.ui.action.MenuAction)context.get("filterAction");
  ...
  bean.setCode("filter");
  bean.setName(getI18nFB_1684d9c());
...
private java.lang.String getI18nFB_1684d9c(){
 if(context.get("nc.ui.uif2.I18nFB#1684d9c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1684d9c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1684d9c",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1684d9c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.uif2.actions.QueryAction getList_searchAction(){
 ...
 return (nc.ui.uif2.actions.QueryAction)context.get("list_searchAction");
  ...
  bean.setModel(getBaseinfoModel());
  bean.setDataManager(getModelDataManager());
  bean.setQueryDelegator(getAutoShowDisableDataQueryDelagator_16e4406());
...
private nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator getAutoShowDisableDataQueryDelagator_16e4406(){
 if(context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16e4406")!=null)
 return (nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator)context.get("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16e4406");
  nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator bean = new nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator();
  context.put("nc.ui.bd.pub.query.AutoShowDisableDataQueryDelagator#16e4406",bean);
  bean.setContext(getContext());
...
private List getManagedList19(){  List list = new ArrayList();  list.add(getSupBaseInfoBatchUpdateTab_532585());  list.add(getSupFinanceBatchUpdateTab_14a09e());  list.add(getSupStockBatchUpdateTab_1130bed());  return list;}

private nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab getSupBaseInfoBatchUpdateTab_532585(){
 if(context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#532585")!=null)
 return (nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab)context.get("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#532585");
  nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab bean = new nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab();
  context.put("nc.ui.bd.supplier.config.SupBaseInfoBatchUpdateTab#532585",bean);
...
private nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab getSupFinanceBatchUpdateTab_14a09e(){
 if(context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#14a09e")!=null)
 return (nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab)context.get("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#14a09e");
  nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab bean = new nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab();
  context.put("nc.ui.bd.supplier.finance.SupFinanceBatchUpdateTab#14a09e",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.stock.SupStockBatchUpdateTab getSupStockBatchUpdateTab_1130bed(){
 if(context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1130bed")!=null)
 return (nc.ui.bd.supplier.stock.SupStockBatchUpdateTab)context.get("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1130bed");
  nc.ui.bd.supplier.stock.SupStockBatchUpdateTab bean = new nc.ui.bd.supplier.stock.SupStockBatchUpdateTab();
  context.put("nc.ui.bd.supplier.stock.SupStockBatchUpdateTab#1130bed",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
private java.lang.String getI18nFB_6433bd(){
 if(context.get("nc.ui.uif2.I18nFB#6433bd")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#6433bd");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#6433bd",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#6433bd",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
private List getManagedList25(){  List list = new ArrayList();  list.add(getSupplierNotNullValidator_13a4439());  return list;}

private nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator getSupplierNotNullValidator_13a4439(){
 if(context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#13a4439")!=null)
 return (nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator)context.get("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#13a4439");
  ...
  context.put("nc.bs.bd.supplier.baseinfo.validator.SupplierNotNullValidator#13a4439",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator getAssociateCustDlgBaseMediator(){
 ...
 return (nc.ui.bd.pub.view.BDEditorOkCancelDialogMediator)context.get("associateCustDlgBaseMediator");
  ...
  bean.setName(getI18nFB_9d05d0());
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
  bean.setSaveAction(getAssociCustSaveAction());
  bean.setCancelAction(getCancelAction_1583d8d());
  bean.setWidth(350);
  bean.setHeight(400);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_9d05d0(){
 if(context.get("nc.ui.uif2.I18nFB#9d05d0")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#9d05d0");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#9d05d0",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#9d05d0",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}

private nc.ui.uif2.actions.CancelAction getCancelAction_1583d8d(){
 if(context.get("nc.ui.uif2.actions.CancelAction#1583d8d")!=null)
 return (nc.ui.uif2.actions.CancelAction)context.get("nc.ui.uif2.actions.CancelAction#1583d8d");
  nc.ui.uif2.actions.CancelAction bean = new nc.ui.uif2.actions.CancelAction();
  context.put("nc.ui.uif2.actions.CancelAction#1583d8d",bean);
  bean.setModel(getAssociCustModel());
  bean.setEditor(getAssociCustView());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
...
private java.lang.String getI18nFB_a81900(){
 if(context.get("nc.ui.uif2.I18nFB#a81900")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#a81900");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#a81900",bean);  bean.setResDir("10140sub");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#a81900",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction getCreateCustSaveAction(){
 ...
 return (nc.ui.bd.supplier.baseinfo.action.CreateCustSaveAction)context.get("createCustSaveAction");
  ...
  bean.setModel(getCreateViewModel());
  bean.setValidationService(getSupplierValidationService_1688960());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.bd.supplier.baseinfo.model.SupplierValidationService getSupplierValidationService_1688960(){
 if(context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1688960")!=null)
 return (nc.ui.bd.supplier.baseinfo.model.SupplierValidationService)context.get("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1688960");
  ...
  context.put("nc.ui.bd.supplier.baseinfo.model.SupplierValidationService#1688960",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator getBaseExtendUIPrcBaseMediator(){
 ...
 return (nc.ui.bd.pub.extend.ExtendOrgBaseUIProcessMediator)context.get("baseExtendUIPrcBaseMediator");
  ...
  bean.setExtendContext(getBaseExtendContext());
  bean.setBaseTabName(getI18nFB_18da398());
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private java.lang.String getI18nFB_18da398(){
 if(context.get("nc.ui.uif2.I18nFB#18da398")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#18da398");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#18da398",bean);  bean.setResDir("10140cub");
  bean.setDefaultValue("基本信息");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#18da398",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
